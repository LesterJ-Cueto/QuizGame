...
def show_page2():
    ...
    text4 = tk.Label(master=interior, text="4.Who is the God of the underworld?", bg="#FFC0CB")
    text4.pack()
    ...
    tk.Radiobutton(interior, text="c) 10 sons & 8 daughters", variable=ans10, value="c) Do-while loop", bg="#FFC0CB").pack()
...
def show_rating():
    ...
    result = tk.Label(master=quiz, text=["Your score is:", str(score), "/10"], font=("Your score is:", 10),
                      fg="#301934")
    result.pack()
    ...
    rightans = tk.Label(master=interior, text="List of the correct answers", font=("Your score is:", 10), bg="#FFC0CB",
                        fg="#808080")
    rightans.pack()
    ...
    button3 = tk.Button(quiz, text="Retry", command=show_page1, fg="black", bg="#90EE90")
    button3.pack()
    button3.place(x=238, y=320)
    # Saving the result
